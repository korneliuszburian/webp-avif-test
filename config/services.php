...
// Core services
$container->set('plugin', function($c) {
...
$container->set('progress_manager', function($c) {
    return new \WpImageOptimizer\Utility\ProgressManager();
});

$container->set('stats', function($c) {
    return new \WpImageOptimizer\Utility\Stats();
});

// Converters
$container->set('webp_converter', function($c) {
...
$container->set('avif_converter', function($c) {
...
// Media services
$container->set('media_processor', function($c) {
...
$container->set('media_library_integration', function($c) {
...
// Admin services
$container->set('admin_page', function($c) {
...
$container->set('dashboard_widget', function($c) {
...
// Frontend services
$container->set('image_delivery', function($c) {
