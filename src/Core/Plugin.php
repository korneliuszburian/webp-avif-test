...
class Plugin {
    ...
    public function boot(): void {
        register_activation_hook(WP_IMAGE_OPTIMIZER_FILE, [$this, 'activate']);
        register_deactivation_hook(WP_IMAGE_OPTIMIZER_FILE, [$this, 'deactivate']);
    ...
    public function activate(): void {
        ...
        $logger->info('Plugin activated', ['version' => WP_IMAGE_OPTIMIZER_VERSION]);
    }
    ...
    public function init(): void {
        ...
        add_filter('wp_handle_upload', [$this->container->get('media_processor'), 'processUploadedMedia']);
    }
