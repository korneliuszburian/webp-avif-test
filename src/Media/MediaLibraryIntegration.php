...
class MediaLibraryIntegration {
    ...
    public function registerHooks(): void {
        ...
        add_filter('attachment_fields_to_edit', [$this, 'addConvertButtons'], 10, 2);
        
        // Add status column to media library
        add_filter('manage_media_columns', [$this, 'addStatusColumn']);
        add_action('manage_media_custom_column', [$this, 'renderStatusColumn'], 10, 2);
        
        // Filter media items by conversion status
        add_action('pre_get_posts', [$this, 'filterMediaItems']);
    ...
    public function addConvertButtons(array $form_fields, object $post): array {
        ...
        // Add convert button
        $form_fields['wp_image_optimizer'] = [
    ...
    private function isSupportedImageType(string $mime_type): bool {
        return in_array($mime_type, ['image/jpeg', 'image/png']);
    }
}
