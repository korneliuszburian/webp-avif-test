...
class MediaProcessor {
    ...
    public function bulkConvertImages(array $ids): void {
        ...
        $this->logger->info("Starting bulk conversion of $totalImages images", ['process_id' => $processId]);
        ...
        foreach ($batches as $index => $batch) {
            ...
            foreach ($batch as $batchIndex => $attachmentId) {
                ...
                $this->logger->info("Processed image $processed/$totalImages", [
        ...
        $this->logger->info("Completed bulk conversion of $totalImages images", ['process_id' => $processId]);
    }
    ...
    private function convertToFormat(int $attachmentId, string $format): bool {
        ...
        $success = $converter->convert($file, $destPath, []);
